...
static RCKeepBGRunManager *_sharedManger;

@interface RCKeepBGRunManager ()
...
@implementation RCKeepBGRunManager
{
...
+ (RCKeepBGRunManager *)shareManager{
    ...
    dispatch_once(&onceToken, ^{
        if (!_sharedManger) {
            _sharedManger = [[RCKeepBGRunManager alloc] init];
        }
    });
