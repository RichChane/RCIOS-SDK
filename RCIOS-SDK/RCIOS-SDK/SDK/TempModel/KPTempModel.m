...
+ (NSMutableDictionary *)createComponum3
{
    ...
    NSMutableDictionary *thirdDict = @{@"广州":@[@"天河区",@"海珠区",@"越秀区",@"白云区",@"荔湾区",@"番禺区",@"南沙区",@"增城区",@"从化区",@"花都区"],@"深圳":@[@"南山区",@"福田区",@"宝安区",@"龙岗区",@"罗湖区"],@"北京":@[@"天安区",@"东城区",@"西城区",@"北城区",@"海淀区"],@"上海":@[@"静安区",@"黄浦区",@"尖沙咀区",@"陆家嘴区",@"外滩区",@"爱情公寓"],@"桂林":@[@"相山区",@"漓江区"],@"南宁":@[@"西乡塘",@"五象区",@"西大区",@"老区"]}.mutableCopy;
